package org.hhorton.queries.kicking;
 ...
 */
public class GetRegularSeasonKickingStatsByPlayerIDAndSeason {
    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public GetRegularSeasonKickingStatsByPlayerIDAndSeason(JdbcTemplate jdbcTemplate) {
